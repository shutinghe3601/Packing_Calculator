...
def best_orientation(warehouse_number, location_number, sku_id):
    ...
    case = pd.read_csv('v2/v2.2_diff_easy/data/caseData.csv').set_index('sku_id')
    loc = pd.read_csv('v2/v2.2_diff_easy/data/locData.csv').set_index(['warehouse_number', 'location_number'])
